<template>
  <div class="col-lg-3 col-6">
    <div class="d-flex items-center">
      ...
      <div class="ml-10">
        <div class="lh-16">Duração</div>
        <div class="text-14 text-light-2 lh-16">{{ duracao }}</div>
      </div>
    </div>
  </div>
  ...
  <div class="col-lg-3 col-6">
    <div class="d-flex items-center">
      ...
      <div class="ml-10">
        <div class="lh-16">Idiomas</div>
        <div class="text-14 text-light-2 lh-16">Espanhol</div>
      </div>
    </div>
  </div>
</template>
...
<script setup>
const props = defineProps(['duracao'])
